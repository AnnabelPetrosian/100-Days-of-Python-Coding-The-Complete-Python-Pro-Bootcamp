...
def compare(user_score, computer_score):
    if user_score == computer_score:
        ...
        return "Win. It's a Blackjack "
    elif user_score > 21:
        return "Your score is over 21. You Lose "
    elif computer_score > 21:
        return "Opponent score is over 21. You Win " 
    elif user_score > computer_score:
        return "Your score is higher compare to opponent's score. You Win "
    else:
        return "Opponent score is higher compare to your score. You Lose  "
...
print(f"    Opponent's final hand is: {computer_cards}, final score is: {computer_score}")
